...
test.describe('Roadmap footer — GitHub Project link', () => {
  ...
  test('Link opens in a new tab with reverse-tabnabbing protection', async ({ page }) => {
    await page.goto(`${BASE}/roadmap.html`);
    const link = page.locator(SELECTOR);
  ...
  test('Link is visible at tablet (768px) and desktop (1280px) viewports', async ({ page }) => {
