...
class BiometricRepositoryImplTest {
    ...
    @Test
    fun `register succeeds when API call succeeds`() =
        runTest {
    ...
    @Test
    fun `register calls correct endpoint with publicKey and deviceId`() =
        runTest {
    ...
    @Test
    fun `register returns failure when API throws ApiException`() =
        runTest {
    ...
    @Test
    fun `register returns failure on network error`() =
        runTest {
    ...
    @Test
    fun `getChallenge returns challenge string on success`() =
        runTest {
            val response =
                JSONObject().apply {
    ...
    @Test
    fun `getChallenge calls correct endpoint with URL-encoded parameters`() =
        runTest {
            var capturedPath: String? = null
    ...
    @Test
    fun `getChallenge URL-encodes special characters in parameters`() =
        runTest {
            var capturedPath: String? = null
            coEvery { apiClient.getPublic(any()) } answers {
                capturedPath = firstArg()
    ...
    @Test
    fun `getChallenge returns failure when API throws`() =
        runTest {
    ...
    @Test
    fun `getChallenge returns failure when response missing challenge field`() =
        runTest {
    ...
    @Test
    fun `getChallenge returns failure on network error`() =
        runTest {
    ...
    @Test
    fun `verify returns customToken on success`() =
        runTest {
            val response =
                JSONObject().apply {
    ...
    @Test
    fun `verify calls correct endpoint with correct payload`() =
        runTest {
            var capturedPath: String? = null
            var capturedBody: JSONObject? = null
    ...
    @Test
    fun `verify returns failure when API returns 401`() =
        runTest {
    ...
    @Test
    fun `verify returns failure when response missing customToken field`() =
        runTest {
    ...
    @Test
    fun `verify returns failure on network error`() =
        runTest {
    ...
    @Test
    fun `revoke succeeds when API call succeeds`() =
        runTest {
    ...
    @Test
    fun `revoke calls correct endpoint with deviceId in path`() =
        runTest {
            var capturedPath: String? = null
    ...
    @Test
    fun `revoke returns failure when API throws ApiException`() =
        runTest {
    ...
    @Test
    fun `revoke returns failure on network error`() =
        runTest {
    ...
    @Test
    fun `revoke calls authenticated delete endpoint`() =
        runTest {
            coEvery { apiClient.delete(any()) } returns JSONObject()
    ...
    @Test
    fun `register uses authenticated post endpoint`() =
        runTest {
            coEvery { apiClient.post(any(), any()) } returns JSONObject()
    ...
    @Test
    fun `getChallenge uses public get endpoint`() =
        runTest {
            coEvery { apiClient.getPublic(any()) } returns
                JSONObject().apply {
                    put("challenge", "nonce")
                }
    ...
    @Test
    fun `verify uses public post endpoint`() =
        runTest {
            coEvery { apiClient.postPublic(any(), any()) } returns
                JSONObject().apply {
