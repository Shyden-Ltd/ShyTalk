...
class OtpRepositoryImplTest {
    ...
    @Test
    fun `sendOtp returns success when API succeeds`() =
        runTest {
    ...
    @Test
    fun `sendOtp returns failure when API throws`() =
        runTest {
    ...
    @Test
    fun `sendOtp returns failure on network error`() =
        runTest {
            coEvery { apiClient.postPublic("/api/auth/otp/send", any()) } throws
    ...
    @Test
    fun `sendOtp calls correct endpoint with email in body`() =
        runTest {
    ...
    @Test
    fun `verifyOtp returns customToken on success`() =
        runTest {
            val response =
                JSONObject().apply {
    ...
    @Test
    fun `verifyOtp returns failure when API throws`() =
        runTest {
    ...
    @Test
    fun `verifyOtp returns failure on network error`() =
        runTest {
            coEvery { apiClient.postPublic("/api/auth/otp/verify", any()) } throws
    ...
    @Test
    fun `verifyOtp returns failure when response missing customToken`() =
        runTest {
    ...
    @Test
    fun `verifyOtp calls correct endpoint with email and code in body`() =
        runTest {
