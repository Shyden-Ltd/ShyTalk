...
| B3  | **Room message reporting** — UK OSA, report mechanism on every UGC screen                                                                                              | Small  | NEXT (Top Priority #4 — small effort, UK OSA blocker)                                                                                              |
...
| B6  | iOS parity                      | Moved to Phase 2, split into B6.1–B6.15 sub-items. As of 2026-05-08: 10 of 15 sub-items DONE (B5, B6.1–B6.9, B6.11, B6.13, B6.14 — last batch #422 deviceId, #543 anchor, #544 typed cancel, #547–#549/#552 cancellation rethrow). Remaining: B6.10 StoreKit (BLOCKED on Apple Developer account), B6.12 resolveReport partial-failure (IN PROGRESS), B6.15 multi-account picker (deferred — UX decision) |
