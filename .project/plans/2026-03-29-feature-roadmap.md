...
| C7  | **Gift-blocked-but-profile-viewable gap** — block-list integrity bug: blocked user can still view profile + see public gifts even though they can't send                | Small  | NEXT (Top Priority #5 — small block-list integrity bugfix)                                                                                              |
