...
- 2026-07-09 — **Reconciled in the MVP-Draft backlog audit ([[SHY-0167]]):** status Draft → In Review. all 10 ViewModel test files present (ConversationList/GroupSetup/PrivateChat/ReportReview/FunFactSplash/DailyReward/AppSettings/RoomSettings/GiftWall/RequiredDOB); develop, post-v0.97.15. Full evidence table: `.project/audit/mvp-backlog-reconciliation-2026-07-08.md`.
