...
- 2026-07-09 — **Reconciled in the MVP-Draft backlog audit ([[SHY-0167]]):** status Draft → In Review. HomeViewModelTest.kt + GachaViewModelTest.kt present; delivered on develop after v0.97.15 (awaiting release). Full evidence table: `.project/audit/mvp-backlog-reconciliation-2026-07-08.md`.
