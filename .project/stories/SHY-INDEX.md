...
| --------------------------------------------------------------- | --- | ------ | -------- | ----------------------------------------------------------------------------------------- | ------------ | ---------------- | -------------------------------------------------------- |
| [SHY-0033](SHY-0033-investigate-stale-branches.md)              | P0  | M      | chore    | Investigate 506-branch sprawl + close stale + enforce 1-active-branch invariant           | 👀 In Review | —                | [#1038](https://github.com/Shyden-Ltd/ShyTalk/pull/1038) |
