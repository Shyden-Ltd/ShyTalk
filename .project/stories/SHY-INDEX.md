...
| --------------------------------------------------------------- | --- | ------ | -------- | ------------------------------------------------------------------------------------------------ | -------------- | ---------------- | --- |
| [SHY-0067](SHY-0067-fix-shy-0002-mirror-comprehensive.md)       | P0  | L      | bug      | Fix SHY-0002 mirror — 4 stacked defects (auth + label auto-create + silent-failure + Project v2 board + Type field) | 👀 In Review | —                | —   |
