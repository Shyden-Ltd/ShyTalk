...
| --------------------------------------------------------------- | --- | ------ | -------- | ------------------------------------------------------------------------------------------------ | -------------- | ---------------- | --- |
| [SHY-0067](SHY-0067-fix-shy-0002-mirror-comprehensive.md)       | P0  | L      | bug      | Fix SHY-0002 mirror — 4 stacked defects (auth + label auto-create + silent-failure + Project v2 board + Type field) | 🚧 In Progress | —                | —   |
| [SHY-0066](SHY-0066-migrate-required-status-checks-to-ruleset.md) | P0 | XS     | infra    | Migrate `required_status_checks` from classic protection to ruleset 12613584 (unblock sync+release) | 👀 In Review | —                | [#1047](https://github.com/Shyden-Ltd/ShyTalk/pull/1047) |
| [SHY-0065](SHY-0065-release-yml-single-jq-pattern.md)           | P1  | XS     | refactor | Apply single-jq inline-additions pattern to release.yml (preventive — mirror SHY-0064 sync fix)  | 👀 In Review | —                | [#1048](https://github.com/Shyden-Ltd/ShyTalk/pull/1048) |
| [SHY-0064](SHY-0064-fix-sync-jq-argv-too-long.md)               | P0  | XS     | bug      | Fix SHY-0063 sync workflow — jq ARG_MAX (single-jq pipeline for 177KB payload)                   | 🚧 In Progress | —                | [#1046](https://github.com/Shyden-Ltd/ShyTalk/pull/1046) |
