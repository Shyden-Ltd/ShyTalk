...
| [SHY-0096](SHY-0096-android-persona-signout-reset.md)           | P1  | M      | infra    | Reliable Android persona-switch — real in-app sign-out (EPIC-0003 / Phase 0 LINCHPIN)            | 🏗️ In Progress | —                | —   |
| [SHY-0097](SHY-0097-warning-acknowledge-server-authorized.md)   | P1  | M      | bug      | Warning-acknowledge silently fails — make it server-authorized (found in SHY-0096 gauntlet)      | 🏗️ In Progress | —                | —   |
