...
| --------------------------------------------------------------- | --- | ------ | -------- | ------------------------------------------------------------------------------------------------ | -------------- | ---------------- | --- |
| [SHY-0066](SHY-0066-migrate-required-status-checks-to-ruleset.md) | P0 | XS     | infra    | Migrate `required_status_checks` from classic protection to ruleset 12613584 (unblock sync+release) | 🚧 In Progress | —                | —   |
