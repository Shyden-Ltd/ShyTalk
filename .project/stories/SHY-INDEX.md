...
| [SHY-0096](SHY-0096-android-persona-signout-reset.md)           | P1  | M      | infra    | Reliable Android persona-switch — real in-app sign-out (EPIC-0003 / Phase 0 LINCHPIN)            | 👀 In Review   | —                | [#1418](https://github.com/Shyden-Ltd/ShyTalk/pull/1418) |
| [SHY-0097](SHY-0097-warning-acknowledge-server-authorized.md)   | P1  | M      | bug      | Warning-acknowledge silently fails — make it server-authorized (found in SHY-0096 gauntlet)      | 👀 In Review   | —                | [#1431](https://github.com/Shyden-Ltd/ShyTalk/pull/1431) |
