...
- **Risk:** Hardcoding "20 locales" (stale) vs the live 5-locale interim. **Mitigation:** Single source `active-locales.mjs` (currently 5); a test asserts every gate reads it; tracks [[project-mvp-locales-five-en-zh-id-vi-th]] + SHY-0194.
